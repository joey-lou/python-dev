...
class WeightConverter:
    ...
    def __init__(self, root):
       ...
       # create input and output cells
        ...
        ttk.Label(mainframe, textvariable=self.kilogram).grid(column=4, row=1, sticky=(W, E))
        ttk.Label(mainframe, text="kg").grid(column=5, row=1, sticky=E)
        ttk.Button(mainframe, text="Calculate", command=self.calculate).grid(column=4, row=2, sticky=(W, E))
